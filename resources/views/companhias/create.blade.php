                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('endereco') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('endereco') ? ' is-invalid' : '' }}" name="endereco" id="input-name" type="text" placeholder="{{ __('Endereço') }}" value="{{ old('endereco') }}" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
